...
class PreferenciaController extends Controller {
	...
	public function index() {
		...
		return view( 'cms.pago.preferencias.index', compact( 'products' ) );
	}
	...
	public function show( $id ) {
		...
		return view( 'cms.pago.preferencias.show', compact( 'product' ) );
	}
	...
	public function edit( $id ) {
		...
		return view( 'cms.pago.preferencias.edit', compact( 'product' ) );
	}
