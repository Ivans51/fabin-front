...
class RespaldoController extends Controller {
	...
	public function index() {
		...
		return view( 'cms.operaciones.respaldo.index', compact( 'products' ) );
	}
	...
	public function show( $id ) {
		...
		return view( 'cms.operaciones.respaldo.show', compact( 'product' ) );
	}
	...
	public function edit( $id ) {
		...
		return view( 'cms.operaciones.respaldo.edit', compact( 'product' ) );
	}
